# fichier de traitement des données de ventes : lecture - transformation - agrégation - export
import sqlite3
import pandas as pd
import os
...
# --- Configuration ---
DB_FILE = os.path.join(PROJECT_ROOT, "sales.db")
...
def generate_all_daily_summaries():
    ...
    try:
        ...
        # --- Étape 3: Préparation des données : convertir date/heure de 'created-at' en datetime.date pour garder la date uniquement puis transforme en texte pour jointure--
        ...
        # --- Étape 4: Agréger les ventes par date, ville et canal de vente---
